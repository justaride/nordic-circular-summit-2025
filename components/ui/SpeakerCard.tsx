        ...
        <div className="mt-4 flex flex-wrap gap-2">
          {speaker.contact.linkedin && (
            <a
              ...
              className="text-xs px-3 py-1.5 rounded transition-colors inline-flex items-center gap-1 hover:bg-[var(--glacial-200)]"
          ...
          {speaker.contact.email && (
            <a
              ...
              className="text-xs px-3 py-1.5 rounded transition-colors inline-flex items-center gap-1 hover:bg-[var(--arctic-200)]"
